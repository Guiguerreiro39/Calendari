...
const daysClassName = cva(
  'grid grid-cols-7 gap-px border-b text-center text-xs font-semibold leading-6 text-neutral-700 lg:flex-none',
  {
    variants: {
      borderColor: {
...
const CalendarDays: React.FC<{ borderColor?: colors }> = ({ borderColor = 'neutral' }) => {
  return (
    <div className={daysClassName({ borderColor })}>
